        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            if (selectedElement is FamilyInstance)
            {
                using(Transaction ts = new Transaction(doc,"Set parameters"))
                {
                    ...
                    Parameter commentParameter = familyInstance.LookupParameter("Длинна");
                    commentParameter.Set("Длинна * 1.1");

                    Parameter typeCommentsParameter = familyInstance.Symbol.LookupParameter("Длинна");
                    typeCommentsParameter.Set("Длинна * 1.1");
                    ts.Commit();
                }
            }
